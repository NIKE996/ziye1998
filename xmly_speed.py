...
UserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 iting/2.1.8 kdtunion_iting/1.0 iting(main)/2.1.8/ios_1"
...
def ans_receive(cookies, paperId, lastTopicId, receiveType):
    headers = {
        'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 iting/2.1.8 kdtunion_iting/1.0 iting(main)/2.1.8/ios_1',
